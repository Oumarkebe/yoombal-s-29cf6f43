...
const BNPLApplicationForm: React.FC<BNPLApplicationFormProps> = ({ product, onSuccess }) => {
      ...
      <Card className="w-full max-w-md">
        ...
        <CardContent className="space-y-4 text-center">
          ...
          <p className="text-gray-600 mb-6">
            Le paiement échelonné est réservé aux membres inscrits. Créez votre compte gratuitement
          ...
          <p className="text-xs text-gray-500 mt-4">
            Vous pouvez continuer vos achats sans compte, mais le BNPL nécessite une inscription.
          </p>
        </CardContent>
      </Card>
    );
    ...
    <Card className="w-full max-w-md max-h-[80vh] overflow-y-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="bg-blue-50 p-4 rounded-lg">
          ...
          <p className="text-2xl font-bold text-blue-700">{product.price.toLocaleString()} CFA</p>
        </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-green-600">
                {selectedCalc.firstPayment.toLocaleString()} CFA
              </span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between pt-2 border-t">
              ...
              <span className="font-bold">
                {selectedCalc.monthlyPayment.toLocaleString()} CFA /mois
              </span>
            </div>
          </div>
        )}
        ...
        <div className="bg-amber-50 p-4 rounded-lg border border-amber-200">
          ...
          <div className="h-24 overflow-y-auto text-xs text-amber-900 bg-white p-2 rounded mb-3 border border-amber-100">
            <p className="mb-2">
              <strong>ENGAGEMENT DE PAIEMENT</strong>
            </p>
            <p>
              Je soussigné(e), m'engage irrévocablement à rembourser la totalité du montant dû selon
              l'échéancier établi.
            </p>
            <p className="mt-2">
            ...
            <p>
              Tout retard de paiement de plus de 5 jours entrainera une pénalité de 5% du montant de
              l'échéance. En cas de non-paiement prolongé, le dossier sera transmis au contentieux.
            </p>
            <p className="mt-2">
              <strong>CONFIDENTIALITE</strong>
            </p>
            <p>
              Vos données personnelles sont traitées conformément à la loi sur la protection des
              données.
            </p>
          </div>
          <div className="flex items-start space-x-2">
            ...
            >
              Je reconnais avoir lu et approuvé les termes du contrat BNPL et je certifie
