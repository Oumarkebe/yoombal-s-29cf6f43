    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[500px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Pour accéder au paiement échelonné (BNPL), nous devons vérifier votre identité
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <p className="text-xs text-slate-500">
                Assurez-vous que les informations sont lisibles et que la pièce est en cours de
                validité.
              </p>
            </div>
          )}
          ...
          {step === 3 && (
            <div className="space-y-4">
              ...
              <div className="border p-4 rounded-md h-40 overflow-y-auto text-sm text-slate-600 mb-4 bg-slate-50">
                ...
                <p>
                  1. En acceptant ce contrat, vous vous engagez à régler l'intégralité du montant dû
                  selon l'échéancier établi.
                </p>
                <p>
                  2. Tout retard de paiement supérieur à 48h entraînera une pénalité de 5% du
                  montant dû.
                </p>
                <p>
                  3. Yoombal se réserve le droit de suspendre l'accès à la plateforme en cas
                  d'impayé.
                </p>
                <p>4. Vous certifiez sur l'honneur que les informations fournies sont exactes.</p>
              </div>
