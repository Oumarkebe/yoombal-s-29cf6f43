...
export const AIModuleCard = ({
  ...
  if (
    ...
    typeof configuration === 'object' &&
    !Array.isArray(configuration) &&
    'pricing_strategy' in configuration
  ) {
  ...
  if (
    ...
    typeof configuration === 'object' &&
    !Array.isArray(configuration) &&
    'prediction_target' in configuration
  ) {
  ...
  if (
    ...
    typeof configuration === 'object' &&
    !Array.isArray(configuration) &&
    'scoring_criteria' in configuration
  ) {
  ...
  if (
    ...
    typeof configuration === 'object' &&
    !Array.isArray(configuration) &&
    'logistics_strategy' in configuration
  ) {
  ...
  return (
    <Card className="flex flex-col transition-all hover:shadow-lg hover:-translate-y-1">
          ...
          <div className="space-y-4">
            ...
            {moduleKey === 'logistics' && (
              <LogisticsStrategySelect
                ...
                onChange={(value) =>
                  onConfigurationChange(moduleKey, { logistics_strategy: value })
                }
                disabled={isUpdating}
      ...
      <CardFooter className="mt-auto bg-gray-50 p-4 flex items-center justify-between border-t">
        <Label htmlFor={`switch-${moduleKey}`} className="text-sm font-medium text-gray-600">
          Activer le module
        </Label>
        <Switch
          id={`switch-${moduleKey}`}
