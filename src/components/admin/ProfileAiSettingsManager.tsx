...
const AI_FEATURES: { key: AiFeatureKey; label: string; description: string }[] = [
  {
    ...
    description: 'Générer des descriptions automatiques, titres, etc.',
  },
  { key: 'pricing', label: 'Pricing IA', description: 'Propositions de prix dynamiques via IA.' },
  {
    key: 'predictions',
    label: 'Analyses Prédictives',
    description: 'Statistiques ou prévisions alimentées par l’IA.',
  },
];
  ...
  if (isLoading)
    return (
      <div className="flex items-center gap-2 text-gray-400">
        <Loader2 className="w-4 h-4 animate-spin" /> Chargement réglages IA…
      </div>
    );
    ...
    <Card className="mt-4">
      <CardHeader>
        ...
        <p className="text-xs text-gray-500">
          Activez ou désactivez chaque outil IA pour chaque type de compte.
        </p>
      </CardHeader>
