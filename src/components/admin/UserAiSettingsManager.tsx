...
const AI_FEATURES_CONFIG: { key: AiFeatureKey; label: string; description: string }[] = [
  ...
  { key: 'pricing', label: 'Pricing Dynamique', description: "Activer les suggestions de prix basées sur l'IA (bientôt disponible)." },
  { key: 'predictions', label: 'Analyses Prédictives', description: "Fournir des prédictions de ventes et de tendances (bientôt disponible)." },
];
        ...
        return (
          <div key={key} className="flex items-start justify-between">
            ...
            <Switch
              ...
              disabled={isUpdating || (key !== 'content_generation')}
            />
          </div>
        );
      })}
