            ...
            <Card>
                <CardHeader>
                    <CardTitle className="flex items-center justify-between">
                        ...
                        <Badge variant="outline" className={`px-3 py-1 text-sm font-semibold border ${getSeoScoreColor()}`}>
                            Score: {seoScore}/100
                        </Badge>
                    </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex gap-2">
                            ...
                            <Button type="button" variant="outline" onClick={generateSlug} title="Générer depuis le nom">
                                Auto
                            </Button>
                        </div>
                    </div>
                        ...
                        <div className="flex items-center justify-between">
                            <div className="space-y-0.5">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Laissez l'IA mettre à jour la description périodiquement pour améliorer la conversion.
                                </p>
                            </div>
                            <Switch
                                checked={formData.ai_description}
                                onCheckedChange={(checked) =>
                                    onChange({ ...formData, ai_description: checked })
                                }
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value: any) =>
                                onChange({ ...formData, ai_pricing_strategy: value })
                            }
                        >
                            <SelectTrigger>
                                <SelectValue />
                                ...
                                <SelectItem value="aggressive">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-2 text-xs text-gray-500">- Maximiser le volume (Marge faible)</span>
                                        </div>
                                    </div>
                                </SelectItem>
                                ...
                                <SelectItem value="premium">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <span className="ml-2 text-xs text-gray-500">- Maximiser la marge (Luxe/Rare)</span>
                                        </div>
                                    </div>
                                </SelectItem>
                            </SelectContent>
