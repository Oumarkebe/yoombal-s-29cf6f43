...
export function AIInsights() {
  ...
  const [insights, setInsights] = useState({
    ...
    marketing: {
      slogan: 'Yoombal : La qualité qui vous simplifie la vie, livrée directement chez vous.',
    },
  ...
  if (isLoading)
    return <div className="p-8 text-center text-gray-500">Chargement des insights IA...</div>;
      ...
      <Card className="border-dashed border-2 bg-slate-50">
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-gray-500 max-w-md mb-6">
            Activez les analyses prédictives pour anticiper vos ventes, optimiser vos stocks et
            doubler votre efficacité.
          </p>
        ...
        <Card className="relative overflow-hidden group">
          ...
          <CardHeader>
            <CardTitle className="text-sm font-medium text-gray-500">
              Prévision Ventes (${config.prediction_horizon_days}j)
            </CardTitle>
          ...
          <CardContent>
            <p className="text-sm text-gray-600">
              L'IA prévoit une hausse du volume de commandes sur vos produits "Électronique" le
              weekend prochain.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-slate-900 text-white border-none shadow-xl">
          ...
          <CardContent>
            <div className="text-2xl font-bold mb-1 text-amber-400">
              {insights.pricing.suggested}
            </div>
            <p className="text-xs text-slate-300 mb-4">{insights.pricing.logic}</p>
