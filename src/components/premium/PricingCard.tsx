...
const PricingCard = ({
    ...
    return (
        <Card className={`relative flex flex-col h-full shadow-lg hover:shadow-xl transition-all duration-300 ${highlight ? 'ring-2 ring-amber-500 scale-105 z-10 bg-white' : 'bg-white/80 border-slate-200'}`}>
            {badge && (
            ...
            <CardHeader className="text-center pb-6 pt-8">
                ...
                <CardDescription className="text-slate-500 mt-2 min-h-[40px]">{description}</CardDescription>
                <div className="mt-6">
