...
const RolePricingSection = ({
  role,
  title,
  subtitle,
  compact = false,
}: RolePricingSectionProps) => {
  const { user } = useAuth();
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 relative z-10">
              <div>
                ...
                <p className="text-slate-400">
                  Pour les grandes enseignes et réseaux de distribution.
                </p>
              </div>
              <Button
                asChild
                variant="outline"
                className="border-slate-700 text-white hover:bg-white/10 h-12 px-8 rounded-xl font-bold text-base"
              >
