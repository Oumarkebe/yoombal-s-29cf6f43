    ...
    return (
        <Card className={cn(
            ...
            <CardContent className="flex-1">
                <div className="mb-6">
                    <span className="text-4xl font-bold">
                        {isFree ? 'Gratuit' : new Intl.NumberFormat('fr-SN', { style: 'currency', currency: 'XOF', maximumFractionDigits: 0 }).format(price || 0)}
                    </span>
                    {!isFree && (
            ...
            <CardFooter>
                ...
                >
                    {isCurrent
                        ? (plan.isExpiringSoon ? 'Renouveler' : 'Plan Actif')
