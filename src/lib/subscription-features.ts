...
export const FEATURE_CATEGORIES: Record<string, string[]> = {
    'merchant': ['custom_store', 'unlimited_products', 'sales_analytics', 'customer_notifications', 'ai_product_descriptions', 'ai_pricing', 'marketing_automation', 'monthly_reports', 'referral_system', 'vip_program', 'gamification', 'product_recommendations', 'predictions', 'fraud_detection', 'stock_prediction', 'export_data', 'bulk_actions', 'api_access', 'ai_assistant', 'content_generation', 'ai_smart_search', 'ai_vision'],
    'delivery': ['delivery_dashboard', 'route_optimization', 'multi_deliveries', 'unlimited_history', 'priority_support'],
