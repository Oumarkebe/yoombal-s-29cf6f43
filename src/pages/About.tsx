        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-gray-600 mb-6">
              Yoombal est une plateforme de commerce électronique innovante qui connecte les
              commerçants locaux avec leurs clients, offrant des solutions de paiement flexibles et
              des services de livraison efficaces.
            </p>

            <h2 className="text-2xl font-semibold text-gray-800 mt-8 mb-4">Notre Mission</h2>
            <p className="text-gray-700 mb-6">
              Démocratiser le commerce électronique en Afrique en offrant aux petites et moyennes
              entreprises les outils nécessaires pour prospérer dans l'économie numérique.
            </p>
