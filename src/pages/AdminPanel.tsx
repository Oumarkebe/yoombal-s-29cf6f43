...
const AdminActionCard = ({
  ...
  const content = (
    <div
      className={`p-6 flex flex-col items-start gap-4 rounded-xl border bg-white shadow-sm transition-all ${disabled ? 'opacity-50 cursor-not-allowed' : 'hover:shadow-md hover:border-amber-200'}`}
    >
          ...
          <div className="mb-8">
            ...
            {isLoading || isLoadingSettings ? (
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                {settings?.dashboard?.showProductCount && (
                  <StatCard
                    ...
                    description="Total des produits sur la plateforme"
                  />
                )}
                {settings?.dashboard?.showOrderCount && (
                  <StatCard
              ...
              <Alert>
                ...
                <AlertDescription>
                  Toutes les statistiques sont actuellement masquées. Vous pouvez les réactiver dans
                  les{' '}
          ...
          <div>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
              <AdminActionCard
                ...
                icon={BarChart}
                description="Voir les statistiques de ventes."
              />
              <AdminActionCard
                name="Produits"
                href="/admin/products"
              ...
              <AdminActionCard
                ...
                href="/admin/kyc"
                icon={ShieldCheck}
                description="Valider les identités pour BNPL."
              />
              <AdminActionCard
                name="Centre Premium"
                href="/admin/ai"
                icon={BrainCircuit}
                description="Gérer toutes les fonctionnalités premium et IA."
              />
              <AdminActionCard
                name="Paramètres"
                href="/admin/settings"
