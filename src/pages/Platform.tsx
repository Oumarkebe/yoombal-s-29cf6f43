      ...
      <main className="flex-1">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-blue-900/80 text-white py-20 md:py-28 text-center">
            <div className="max-w-4xl mx-auto px-4">
                ...
                <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
                    <T>Yoombal connecte clients, marchands et livreurs pour créer un écosystème de commerce inclusif et puissant, adapté aux réalités du Sénégal.</T>
                </p>
            </div>
        </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    {userBenefits.map((item, index) => (
                        <Card key={index} className="flex flex-col border-gray-200 dark:border-gray-800 dark:bg-gray-900/50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
                           <CardHeader className="items-center text-center">
                                ...
                                <p className="text-sm font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-wider"><T>{item.role}</T></p>
                                <CardTitle className="text-2xl"><T>{item.title}</T></CardTitle>
                           </CardHeader>
                           <CardContent className="flex-grow flex flex-col">
                               ...
                               <Button asChild size="lg" className="w-full mt-auto bg-gradient-to-r from-blue-600 to-violet-600 hover:from-blue-700 hover:to-violet-700 text-white">
                                   <Link to={item.link}><T>{item.cta}</T></Link>
                               </Button>
                           </CardContent>
                        </Card>
                    ))}
        ...
        <div className="bg-gray-100 dark:bg-gray-900 py-20">
            <div className="max-w-4xl mx-auto text-center px-4">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4"><T>Prêt à nous rejoindre ?</T></h2>
                <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
                    <T>Créez votre compte en quelques minutes et commencez votre aventure avec Yoombal dès aujourd'hui.</T>
                </p>
                <Button size="lg" className="text-lg px-8" asChild>
                    <Link to="/register"><T>Commencer gratuitement</T></Link>
                </Button>
            </div>
        </div>
      </main>
