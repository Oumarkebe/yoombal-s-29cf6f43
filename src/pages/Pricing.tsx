                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <Tabs defaultValue="merchant" className="space-y-12">
                        <div className="flex justify-center">
                            <TabsList className="bg-slate-100 p-1 rounded-2xl h-auto border border-slate-200">
                                <TabsTrigger value="client" className="rounded-xl px-8 py-3 data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all flex items-center gap-2">
                                    <Users className="h-4 w-4" />
                                    <span>Acheteur</span>
                                </TabsTrigger>
                                <TabsTrigger value="merchant" className="rounded-xl px-8 py-3 data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all flex items-center gap-2">
                                    <Store className="h-4 w-4 text-blue-600" />
                                    <span>Vendeur</span>
                                </TabsTrigger>
                                <TabsTrigger value="delivery" className="rounded-xl px-8 py-3 data-[state=active]:bg-white data-[state=active]:shadow-sm transition-all flex items-center gap-2">
                        ...
                        <TabsContent value="merchant" className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                    ...
                    <div className="mt-24 bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-slate-100">
                        ...
                        <div className="grid md:grid-cols-2 gap-x-12 gap-y-8 text-left">
                            {[
                                { q: "Y a-t-il des frais cachés ?", a: "Non, tous nos tarifs sont transparents. Les commissions ne s'appliquent qu'en cas de vente ou de mission réussie." },
                                { q: "Comment fonctionne la commission ?", a: "La commission est prélevée automatiquement lors de la transaction finale, incluant les frais de service et l'accès aux outils de gestion." },
                                { q: "Puis-je changer de plan ?", a: "Oui, vous pouvez activer ou désactiver vos options IA et Premium à tout moment depuis votre profil." },
                                { q: "Le support est-il local ?", a: "Absolument. Nos équipes sont basées à Dakar et disponibles pour vous aider 7j/7." }
                            ].map((item, i) => (
                                <div key={i}>
