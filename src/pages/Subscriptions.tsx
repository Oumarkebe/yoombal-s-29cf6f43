...
export default function Subscriptions() {
  ...
  const [actionType, setActionType] = useState<
    'subscribe' | 'renew' | 'change' | 'module_purchase'
  >('subscribe');
    ...
    <div className="min-h-screen bg-white pt-24 pb-20">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-16">
          ...
          <Badge
            variant="outline"
            className="text-primary border-primary/20 bg-primary/5 px-4 py-1 animate-pulse"
          >
          ...
          <p className="text-xl text-muted-foreground max-w-2xl">
            Des outils de pointe basés sur l'IA pour automatiser vos ventes, prédire vos stocks et
          ...
          <div className="flex flex-col items-center pt-8 gap-4">
            ...
            >
              <TabsList className="bg-transparent h-12">
                <TabsTrigger
                  value="monthly"
                  className="rounded-full px-8 data-[state=active]:bg-white data-[state=active]:shadow-sm"
                >
                  Mensuel
                </TabsTrigger>
                <TabsTrigger
          ...
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="item-1" className="border-b-muted">
              ...
              <AccordionContent className="text-muted-foreground">
                Nous acceptons les paiements via Orange Money et Wave. C'est simple, rapide et
                sécurisé. Vous recevrez une notification sur votre téléphone pour valider la
                transaction.
              </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-2" className="border-b-muted">
              ...
              <AccordionContent className="text-muted-foreground">
                Oui ! Vous pouvez passer à un plan supérieur à tout moment. La différence de prix
                sera calculée au prorata pour la période restante.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
