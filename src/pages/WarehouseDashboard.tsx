          ...
          <Dialog open={isMovementModalOpen} onOpenChange={setIsMovementModalOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Enregistrez une entrée ou une sortie de stock pour cet entrepôt.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    placeholder="Scanner ou entrer ID..."
                    value={productId}
                ...
                <Button className="w-full" onClick={handleMovementSubmit}>
                  Valider Mouvement
                </Button>
              </div>
            </DialogContent>
                  ...
                  <TableCell className="font-medium">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-slate-400 font-mono opacity-0 group-hover:opacity-100">
