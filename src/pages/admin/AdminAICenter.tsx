...
export default function AdminAICenter() {
  ...
  const [botSettings, setBotSettings] = useState({
    systemPrompt:
      "Tu es l'Assistant IA Teranga, un griot moderne et expert commercial pour Yoombal, la plateforme e-commerce de référence au Sénégal.",
  ...
  const initializeDefaultFeatures = async () => {
    const defaultFeatures = [
      // ANALYTICS (4)
      {
        ...
        description: 'Prévisions de ventes et tendances du marché',
        category: 'analytics',
        price_monthly: 4900,
        trial_days: 14,
      },
      {
        feature_key: 'tableau_bord_avance',
        name: 'Tableau de Bord Avancé',
        description: 'Métriques temps réel et KPI personnalisés',
        category: 'analytics',
        price_monthly: 2900,
        trial_days: 7,
      },
      {
        feature_key: 'rapports_personnalises',
        name: 'Rapports Personnalisés',
        description: 'Génération automatique de rapports sur mesure',
        category: 'analytics',
        price_monthly: 1900,
        trial_days: 7,
      },
      {
        feature_key: 'analyse_comportement',
        name: 'Analyse Comportementale',
        description: 'Tracking utilisateur et parcours client détaillé',
        category: 'analytics',
        price_monthly: 3900,
        trial_days: 14,
      },
      ...
      // CONTENT (4)
      {
        feature_key: 'generation_contenu',
        name: 'Génération de Contenu IA',
        description: 'Descriptions produits automatiques optimisées',
        category: 'content',
        price_monthly: 5900,
        trial_days: 14,
      },
      {
        feature_key: 'optimisation_seo',
        name: 'Optimisation SEO',
        description: 'Amélioration automatique du référencement Google',
        category: 'content',
        price_monthly: 3900,
        trial_days: 7,
      },
      {
        feature_key: 'traduction_auto',
        name: 'Traduction Automatique',
        description: 'Multilingue avec IA (Français, English, Wolof)',
        category: 'content',
        price_monthly: 2900,
        trial_days: 7,
      },
      {
        feature_key: 'suggestions_images',
        name: "Suggestions d'Images IA",
        description: 'Recommandations visuelles intelligentes',
        category: 'content',
        price_monthly: 1900,
        trial_days: 7,
      },
      ...
      // COMMERCE (5)
      {
        feature_key: 'ai_pricing',
        name: 'Tarification Dynamique',
        description: 'Prix adaptatifs selon demande et concurrence',
        category: 'commerce',
        price_monthly: 7900,
        trial_days: 30,
      },
      {
        feature_key: 'recommandations_produits',
      ...
      {
        feature_key: 'gestion_stock_ia',
        name: 'Gestion Stock Intelligente',
        description: 'Prévisions et alertes automatiques de rupture',
        category: 'commerce',
        price_monthly: 5900,
        trial_days: 14,
      },
      {
        feature_key: 'detection_fraude',
        name: 'Détection de Fraude',
        description: 'Protection transactions avec machine learning',
        category: 'commerce',
        price_monthly: 6900,
        trial_days: 30,
      },
      {
        feature_key: 'panier_abandonne',
        name: 'Récupération Panier',
        description: 'Relances automatisées intelligentes',
        category: 'commerce',
        price_monthly: 3900,
        trial_days: 14,
      },
      ...
      // SUPPORT (4)
      {
        ...
        name: 'Assistant IA Teranga',
        description: 'Support client 24/7 automatisé et intelligent (Griot IA)',
        category: 'support',
        price_monthly: 8900,
        trial_days: 30,
      },
      {
        feature_key: 'faq_auto',
        name: 'FAQ Automatique',
        description: 'Réponses générées et mises à jour par IA',
        category: 'support',
        price_monthly: 2900,
        trial_days: 7,
      },
      {
        feature_key: 'tickets_priorite',
        name: 'Priorisation Tickets',
        description: 'Tri automatique par urgence et type',
        category: 'support',
        price_monthly: 3900,
        trial_days: 14,
      },
      {
        ...
        description: 'Détection satisfaction client en temps réel',
        category: 'support',
        price_monthly: 4900,
        trial_days: 14,
      },
      ...
      // MARKETING (4)
      {
        feature_key: 'campagnes_auto',
        name: 'Campagnes Automatisées',
        description: 'Email et SMS marketing intelligents',
        category: 'marketing',
        price_monthly: 5900,
        trial_days: 14,
      },
      {
        feature_key: 'segmentation_client',
        name: 'Segmentation Avancée',
        description: 'Groupes clients optimisés par IA',
        category: 'marketing',
        price_monthly: 4900,
        trial_days: 14,
      },
      {
        feature_key: 'ab_testing_auto',
        name: 'A/B Testing Automatique',
        description: 'Optimisation continue des conversions',
        category: 'marketing',
        price_monthly: 3900,
        trial_days: 14,
      },
      {
        feature_key: 'prediction_churn',
        name: 'Prédiction de Churn',
        description: 'Identification clients à risque de départ',
        category: 'marketing',
        price_monthly: 6900,
        trial_days: 14,
      },
      ...
      // SECURITY (2)
      {
        feature_key: 'audit_securite',
        name: 'Audit Sécurité IA',
      ...
      {
        feature_key: 'monitoring_temps_reel',
        name: 'Monitoring Temps Réel',
        description: 'Alertes anomalies système instantanées',
        category: 'security',
        price_monthly: 5900,
        trial_days: 14,
      },
      ...
      // AFRICA SPECIFIC (5)
      {
        feature_key: 'mobile_money_ia',
        name: 'Mobile Money Intelligent',
        description: 'OM/Wave avec détection fraude avancée',
        category: 'africa',
        price_monthly: 6900,
        trial_days: 30,
      },
      {
        feature_key: 'wolof_pulaar_nlp',
        name: 'NLP Wolof/Pulaar',
        description: 'Compréhension langues locales pour chatbot',
        category: 'africa',
        price_monthly: 8900,
        trial_days: 30,
      },
      {
        feature_key: 'livraison_zone_rurale',
        name: 'Livraison Zone Rurale',
        description: 'Optimisation routes zones difficiles',
        category: 'africa',
        price_monthly: 4900,
        trial_days: 14,
      },
      {
        feature_key: 'paiement_tontine',
        name: 'Tontines Digitales',
        description: 'Paiement différé communautaire et groupes',
        category: 'africa',
        price_monthly: 5900,
        trial_days: 14,
      },
      {
        feature_key: 'adaptation_ramadan',
        name: 'Adaptation Ramadan/Tabaski',
        description: 'Prix et stock dynamiques périodes religieuses',
        category: 'africa',
        price_monthly: 3900,
        trial_days: 7,
      },
      ...
      // VERTICAL METIERS (4)
      {
        feature_key: 'mode_textile_ia',
        name: 'IA Mode & Textile',
        description: 'Reconnaissance tissus, conseils tailles/morpho',
        category: 'vertical',
        price_monthly: 4900,
        trial_days: 14,
      },
      {
        feature_key: 'alimentaire_frais',
        name: 'Alimentaire Frais',
        description: 'Gestion péremption et rotation FIFO',
        category: 'vertical',
        price_monthly: 3900,
        trial_days: 14,
      },
      {
        feature_key: 'cosmetiques_naturels',
        name: 'Cosmétiques Naturels',
        description: 'Recommandations type peau/cheveux afro',
        category: 'vertical',
        price_monthly: 4900,
        trial_days: 14,
      },
      {
        feature_key: 'electronique_tech',
        name: 'Électronique & Tech',
        description: 'Détection compatibilité et comparaisons specs',
        category: 'vertical',
        price_monthly: 3900,
        trial_days: 7,
      },
      ...
      // LOGISTICS (3)
      {
        feature_key: 'optimisation_tournees',
        name: 'Optimisation Tournées Multi-Points',
        description: 'Algorithmes avancés pour livreurs',
        category: 'logistics',
        price_monthly: 5900,
        trial_days: 14,
      },
      {
        feature_key: 'prevision_trafic',
        name: 'Prévision Trafic Dakar',
        description: 'Estimations temps réel embouteillages',
        category: 'logistics',
        price_monthly: 3900,
        trial_days: 14,
      },
      {
        feature_key: 'gestion_entrepots',
        name: 'Gestion Entrepôts Multi-Zones',
        description: 'IA placement optimal produits',
        category: 'logistics',
        price_monthly: 4900,
        trial_days: 14,
      },
      ...
      // FINANCE (3)
      {
        feature_key: 'credit_scoring',
        name: 'Credit Scoring IA',
        description: 'Évaluation solvabilité BNPL sans banque',
        category: 'finance',
        price_monthly: 7900,
        trial_days: 30,
      },
      {
        feature_key: 'detection_blanchiment',
        name: 'Détection Blanchiment',
        description: 'Conformité BCEAO et réglementations',
        category: 'finance',
        price_monthly: 6900,
        trial_days: 30,
      },
      {
        feature_key: 'facturation_electronique',
        name: 'Facturation Électronique',
        description: 'Conformité fiscale automatique Sénégal',
        category: 'finance',
        price_monthly: 3900,
        trial_days: 14,
      },
      ...
      // SOCIAL (3)
      {
        feature_key: 'influence_locale',
        name: 'Micro-Influenceurs Locaux',
        description: 'Identification ambassadeurs quartiers',
        category: 'social',
        price_monthly: 4900,
        trial_days: 14,
      },
      {
        feature_key: 'groupes_achat',
        name: "Groupes d'Achat Intelligents",
        description: 'Organisation achats groupés optimisés',
        category: 'social',
        price_monthly: 3900,
        trial_days: 14,
      },
      {
        feature_key: 'fidelite_gamifie',
        name: 'Programme Fidélité Gamifié',
        description: 'Points, badges, défis communautaires',
        category: 'social',
        price_monthly: 5900,
        trial_days: 14,
      },
      ...
      // PERSONALIZATION (2)
      {
        feature_key: 'assistant_vocal_teranga',
        name: 'Assistant Vocal Teranga',
        description: 'Voix sénégalaises et accents locaux',
        category: 'personalization',
        price_monthly: 7900,
        trial_days: 30,
      },
      {
        feature_key: 'reco_evenements',
        name: 'Recommandations Événements',
        description: 'Tabaski, mariages, baptêmes, cérémonies',
        category: 'personalization',
        price_monthly: 3900,
        trial_days: 7,
      },
  ...
  const getTotalMonthlyCost = () =>
    features.filter((f) => f.is_enabled).reduce((sum, f) => sum + (f.price_monthly || 0), 0);
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gérez {features.length} modules cognitifs premium avec suivi de durée.
          </p>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-600">
              {getActiveCount()} / {features.length}
            </div>
            ...
            return (
              <Card key={category}>
                <CardHeader>
                  ...
                  <CardDescription>
                    {categoryFeatures.length} fonctionnalités •{' '}
                    {categoryFeatures.filter((f) => f.is_enabled).length} actives
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                  {categoryFeatures.map((feature) => {
                    ...
                    return (
                      <div
                        key={feature.id}
                        className="flex items-start justify-between space-x-2 p-3 rounded-lg hover:bg-accent/50 transition-colors border"
                      >
                            ...
                            <div className="flex items-center gap-4 text-xs text-muted-foreground mt-2">
                              {feature.activated_at && (
                                <span className="flex items-center gap-1">
                                  ...
                                  Activé le{' '}
                                  {format(new Date(feature.activated_at), 'dd MMM yyyy', {
                                    locale: fr,
                                  })}
                                </span>
                              )}
                              {feature.expires_at && daysLeft !== null && (
                                <span
                                  className={`flex items-center gap-1 ${daysLeft < 7 ? 'text-red-600 font-medium' : ''}`}
                                >
                              ...
                              {editingPriceId === feature.id ? (
                                ...
                                <>
                                  ...
                                  <Button
                                    ...
                                    onClick={() =>
                                      startEditingPrice(feature.id, feature.price_monthly)
                                    }
                                  >
                        ...
                        <div className="flex items-center gap-2">
                          <Dialog>
                            ...
                            <DialogContent>
                              <DialogHeader>
                                <DialogTitle>
                                  Configuration: {configDialogFeature?.name}
                                </DialogTitle>
                                <DialogDescription>
                              ...
                              <div className="space-y-4 py-4">
                                <div className="space-y-2">
                                  ...
                                  <Input
                                    ...
                                    value={tempTrialDays}
                                    onChange={(e) =>
                                      setTempTrialDays(parseInt(e.target.value) || 0)
                                    }
                                  />
                                ...
                                <div className="flex items-center justify-between p-3 bg-muted/50 rounded-lg border border-dashed border-amber-300">
                                  <div className="space-y-0.5">
                                    <Label
                                      htmlFor="free-mode"
                                      className="text-amber-700 font-bold flex items-center gap-2"
                                    >
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    setBotSettings((prev) => ({ ...prev, systemPrompt: e.target.value }))
                  }
                />
                <p className="text-xs text-muted-foreground">
                  Instruction qui guide toutes les réponses du bot.
                </p>
              </div>
              <div className="space-y-2">
              ...
              <div className="pt-4 border-t border-dashed">
                <Label
                  htmlFor="openai-key"
                  className="text-amber-700 font-medium flex items-center gap-2 mb-2"
                >
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    onChange={(e) =>
                      setAiKeys((prev) => ({ ...prev, openaiApiKey: e.target.value }))
                    }
                    className="font-mono text-xs"
                  />
                </div>
                <p className="text-[10px] text-muted-foreground mt-2">
                  Nécessaire pour faire fonctionner le chatbot. La clé est stockée de manière
                  sécurisée.
                </p>
              </div>
            </CardContent>
