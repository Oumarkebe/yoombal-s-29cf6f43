                ...
                <Card className="md:col-span-2">
                  ...
                  <CardContent>
                    <div className="bg-emerald-50 border border-emerald-100 rounded-lg p-6 mb-6 flex flex-col items-center justify-center text-center">
                      <p className="text-sm font-medium text-emerald-800 uppercase tracking-widest mb-2">
                        Cagnotte du Mois
                      </p>
                      <h2 className="text-4xl font-bold text-emerald-900 mb-2">250,000 FCFA</h2>
                      <p className="text-emerald-700">
                        Bénéficiaire : <strong>Moussa Sow</strong> (Février)
                      </p>
                    </div>
                          ...
                          <TableRow key={m.id}>
                            ...
                            <TableCell>
                              {m.name.includes('Vous') && !contributionPaid ? (
                                ...
                                <Badge
                                  variant={m.status === 'retard' ? 'destructive' : 'outline'}
                                  className={
                                    m.status === 'payé' || contributionPaid
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <Button
                      ...
                      onClick={handlePayContribution}
                      disabled={contributionPaid}
                    >
                      {contributionPaid ? 'Cotisation à jour' : 'Payer par Mobile Money'}
                    </Button>
                    <p className="text-xs text-center text-gray-400">Sécurisé par Yoombal Trust™</p>
                  </CardContent>
                </Card>
              </div>
            </PremiumFeatureGate>
                          ...
                          <TableRow key={tx.id}>
                            ...
                            <TableCell>
                              {tx.status === 'safe' ? (
                                <Badge
                                  variant="outline"
                                  className="text-green-700 bg-green-50 border-green-200 flex w-fit gap-1 items-center"
                                >
                                ...
                                <Badge
                                  variant="destructive"
                                  className="flex w-fit gap-1 items-center animate-pulse"
                                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                <Card className="h-full flex flex-col items-center justify-center p-8 text-center bg-gradient-to-br from-slate-900 to-slate-800 text-white border-none shadow-xl">
                  ...
                  <p className="text-slate-400 mb-6 max-w-sm">
                    Basé sur vos transactions Mobile Money, votre historique Tontine et vos ventes
                    Yoombal.
                  </p>
                    ...
                    <CardContent className="p-4 flex gap-4 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">
                          Activé pour vos achats fournisseurs jusqu'à 1M FCFA.
                        </p>
                      </div>
                    </CardContent>
                  </Card>
                    ...
                    <CardContent className="p-4 flex gap-4 items-start">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400">
                          Nécessite un score &gt; 800. Continuez vos efforts !
                        </p>
                      </div>
                    </CardContent>
                  </Card>
