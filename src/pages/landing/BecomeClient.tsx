        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-600 mb-12 leading-relaxed max-w-2xl mx-auto">
              Découvrez des milliers de produits locaux uniques. Achetez maintenant, payez plus tard
              avec BNPL, et profitez d'une livraison express.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                asChild
                size="lg"
                className="h-14 px-8 text-lg bg-orange-600 hover:bg-orange-700 text-white shadow-xl shadow-orange-500/20 rounded-full transition-all hover:scale-105"
              >
                <Link to={ctaLink}>
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="h-14 px-8 text-lg border-slate-200 bg-white text-slate-700 hover:bg-slate-50 rounded-full"
              >
        ...
        <div className="container mx-auto px-6">
          <div className="bg-slate-900 rounded-3xl p-12 text-center text-white relative overflow-hidden">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-8 relative z-10">
              Envie de chiner les meilleures offres ?
            </h2>
            <Button
              asChild
              size="lg"
              className="h-16 px-12 text-lg bg-white text-slate-900 hover:bg-slate-100 rounded-full font-bold relative z-10"
            >
              <Link to={ctaLink}>Créer un compte gratuit</Link>
            </Button>
          </div>
        </div>
      </section>
