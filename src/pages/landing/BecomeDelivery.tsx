          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-slate-300 mb-10 leading-relaxed max-w-lg">
                Rejoignez la flotte Yoombal. Une liberté totale, des paiements rapides et une
                application intuitive pour maximiser vos gains.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  size="lg"
                  className="h-14 px-8 text-lg bg-emerald-500 hover:bg-emerald-600 text-white shadow-lg shadow-emerald-500/25 rounded-full transition-all hover:scale-105"
                >
                  <Link to={ctaLink}>
            ...
            {[
              {
                ...
                desc: 'Créez votre compte en quelques minutes en ligne.',
              },
              {
                step: 2,
                title: 'Validez',
                desc: 'Nous vérifions vos documents pour la sécurité de tous.',
              },
      ...
      <section className="py-24 bg-emerald-900 text-white rounded-t-[3rem] mt-[-2rem] relative z-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-emerald-100 text-lg mb-10 max-w-xl mx-auto">
            Rejoignez la communauté des livreurs Yoombal et commencez à générer des revenus dès
            aujourd'hui.
          </p>
          <Button
            asChild
            size="lg"
            className="h-16 px-10 text-xl bg-white text-emerald-900 hover:bg-emerald-50 rounded-full shadow-2xl"
          >
            <Link to={ctaLink}>S'inscrire maintenant</Link>
          </Button>
        </div>
      </section>
    </div>
