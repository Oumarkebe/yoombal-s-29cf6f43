      ...
      <section className="relative pt-24 pb-32 overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto mb-12 leading-relaxed">
            Rejoignez la plateforme e-commerce nouvelle génération. Profitez de nos outils d'IA, de
            notre logistique intégrée et d'une visibilité nationale.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              asChild
              size="lg"
              className="h-14 px-8 text-lg bg-amber-500 hover:bg-amber-600 text-white shadow-lg shadow-amber-500/25 rounded-full transition-all hover:scale-105"
            >
              <Link to={ctaLink}>
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="h-14 px-8 text-lg border-slate-600 bg-transparent text-white hover:bg-white/10 rounded-full"
            >
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Une suite d'outils puissants conçue pour propulser votre business vers de nouveaux
              sommets.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={i}
                className="border-none shadow-lg hover:shadow-xl transition-all duration-300 bg-slate-50/50 hover:bg-white group"
              >
            ...
            {[
              {
                ...
                rating: 5,
                comment:
                  "Grâce à Yoombal, j'ai pu doubler mes ventes en 6 mois. Le système BNPL attire beaucoup plus de clients.",
              },
              {
                name: 'Moussa Ba',
                ...
                rating: 5,
                comment:
                  'La plateforme est facile à utiliser et le support client est excellent. Je recommande vivement.',
              },
              {
                name: 'Fatou Seck',
                ...
                rating: 5,
                comment:
                  "Yoombal m'a permis de vendre mes produits dans tout le Sénégal. C'est révolutionnaire !",
              },
      ...
      <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-12">
            Rejoignez les centaines de marchands qui font confiance à Yoombal. Ouvrez votre boutique
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center max-w-md mx-auto">
            <Button
              asChild
              size="lg"
              className="w-full h-14 text-lg bg-amber-500 hover:bg-amber-600 text-white shadow-xl rounded-xl border-none"
            >
              <Link to={ctaLink}>
                Créer ma boutique
