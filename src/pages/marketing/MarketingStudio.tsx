              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Décrivez votre produit, l'IA s'occupe du reste.
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-2">
                        ...
                        >
                          <Instagram className="w-4 h-4 mr-2" /> Post Instagram
                        </Button>
                        <Button
                          variant="outline"
                          size="sm"
                        ...
                        >
                          <Search className="w-4 h-4 mr-2" /> Description SEO
                        </Button>
                      </div>
                    </div>
                    <Button
            ...
            <PremiumFeatureGate featureKey="influence_locale">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Algorithme de matching basé sur votre niche (Mode Masculine).
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <PremiumFeatureGate featureKey="campagnes_auto">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Envoyez des promos ciblées à vos segments clients.
                  </CardDescription>
                </CardHeader>
                <CardContent className="flex flex-col items-center justify-center p-8 text-center space-y-4">
                  ...
                  <p className="max-w-md text-gray-500">
                    L'IA a détecté que le segment "Clients Fidèles (Dakar)" réagit bien aux promos
                    du Vendredi.
                  </p>
                  <Button
