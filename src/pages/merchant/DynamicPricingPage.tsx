  ...
  const handleSimulate = () => {
    ...
    setTimeout(() => {
      ...
      const optimizedPrice = Math.round(
        product.currentPrice * multiplier * (1 + (demandSensitivity[0] - 50) / 500)
      );
      ...
      <PremiumFeatureGate featureKey="ai_pricing">
        <main className="flex-grow container mx-auto px-4 py-8 max-w-6xl">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <Badge
              variant="outline"
              className="border-amber-200 bg-amber-50 text-amber-700 px-4 py-1.5 flex gap-2"
            >
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-indigo-800/80">
                    ...
                    <li className="flex gap-2 items-start">
                      ...
                      Choisissez une stratégie : <strong>Agressif</strong> pour le volume,{' '}
                      <strong>Concurrentiel</strong> pour suivre le marché, ou{' '}
                      <strong>Conservateur</strong> pour la marge.
                    </li>
                    <li className="flex gap-2 items-start">
                      <span className="font-bold text-indigo-500">3.</span>
                      Validez les nouveaux prix pour qu'ils s'appliquent automatiquement sur votre
                      boutique.
                    </li>
                  </ul>
                  <div className="mt-4">
                    <Button
                      variant="link"
                      className="p-0 h-auto text-indigo-700 font-semibold text-xs"
                    >
