...
import { Calendar, CreditCard, RotateCw, Shield, AlertTriangle, CheckCircle2, Sparkles, Layers } from 'lucide-react';
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="p-4 rounded-2xl bg-muted/30 border text-center space-y-1">
                                            ...
                                            <p className={subscription?.auto_renew ? "text-green-600 font-bold" : "text-orange-600 font-bold"}>
