    ...
    return (
      <div className="container p-8 flex flex-col items-center justify-center space-y-4">
        ...
        <p className="text-muted-foreground animate-pulse">
          Chargement de votre univers Premium...
        </p>
      </div>
    );
  }
              ...
              <div className="flex justify-between items-center">
                <div className="space-y-1">
                  <CardTitle className="text-2xl font-black flex items-center gap-2">
                    <Shield
                      className={
                        isPaidPlan ? 'text-primary h-6 w-6' : 'text-muted-foreground h-6 w-6'
                      }
                    />
                    Plan {planName}
                  </CardTitle>
                  <div className="flex items-center gap-2">
                    <CardDescription>
                      {isPaidPlan
                        ? 'Votre moteur est à pleine puissance.'
                        : 'Activez la vitesse supérieure.'}
                    </CardDescription>
                ...
                <Badge
                  ...
                  className={
                    isPaidPlan
                      ? 'bg-gradient-to-r from-primary to-accent px-4 py-1 text-sm font-bold shadow-lg'
                      : 'px-4 py-1'
                  }
                >
                  ...
                  <div className="p-8 rounded-2xl bg-gradient-to-br from-muted/50 to-muted/20 border-2 border-dashed flex flex-col items-center justify-center text-center space-y-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Boostez votre business avec nos outils IA.
                      </p>
                    </div>
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {currentPlan?.features?.map((feature, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-2 p-3 rounded-xl bg-green-50/50 border border-green-100 text-sm"
                    >
                ...
                <>
                  ...
                  <div className="flex gap-3 w-full sm:w-auto">
                    <Button
                      ...
                      onClick={() => {
                        if (
                          window.confirm('Voulez-vous désactiver le renouvellement automatique ?')
                        ) {
                ...
                <div className="w-full flex items-center justify-between p-2 bg-amber-50 rounded-lg border border-amber-100">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm font-medium text-amber-900">
                      -20% sur l'abonnement annuel cette semaine !
                    </p>
                  </div>
                  <Button
                    size="sm"
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Activez seulement les outils dont vous avez besoin.
                </p>
              </div>
            </div>
              ...
              <ScrollArea className="h-[600px] pr-4">
                <div className="space-y-6">
                  ...
                  {[
                    ...
                    {
                      title: 'Module IA Assistant',
                      date: new Date(Date.now() - 86400000),
                      type: 'module',
                      amount: 4900,
                    },
                    {
                      title: 'Paiement Annuel Wave',
                    ...
                    <div key={i} className="flex gap-3 relative pb-6 group">
                      {i !== 2 && (
                        <div className="absolute left-[11px] top-6 bottom-0 w-[2px] bg-muted group-last:hidden" />
                      )}
