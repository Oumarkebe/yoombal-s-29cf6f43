  ...
  public: {
    Tables: {
      ...
      warehouse_movements: {
        ...
        Relationships: [
          {
            foreignKeyName: 'warehouse_movements_from_warehouse_id_fkey';
          ...
          {
            foreignKeyName: 'warehouse_movements_to_warehouse_id_fkey';
          ...
          {
            foreignKeyName: 'warehouse_movements_performed_by_fkey';
